...
public class Zunggg extends MapObject {
  ...
  public void paint(Graphics2D g, ImageHandler images, Point ref_cell, Point ref_cell_nw_pixel,
    ...
    g.setStroke(new BasicStroke(Math.min(pixels_per_cell / Constants.ZUNGGG_STROKE_WIDTH_DIVISOR, 2)));
    int num_bolts =
            Math.min(pixels_per_cell / Constants.ZUNGGG_NUM_BOLTS_DIVISOR, Constants.ZUNGGG_MIN_NUM_BOLTS);
