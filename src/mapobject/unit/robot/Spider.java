...
public class Spider extends Robot {
  ...
  public Spider(Room room, double x_loc, double y_loc, double direction) {
    super(Unit.getRadius(ObjectType.Spider), new FireballCannon(SPIDER_CANNON_DAMAGE, false), room, x_loc,
            y_loc, direction);
  ...
  public MapObject handleDeath(MapEngine engine, double s_elapsed) {
    MapObject created_objects = super.handleDeath(engine, s_elapsed);
    if (!is_in_map) {
